...
if [[ "$INSTALL_VIA_NIX" == "true" ]]; then
  ...
  if ! [[ "${TARGET_ID}" = "arch" ]]; then
    ...
    if [[ "${tmp_update_status}" =~ ^(OUTDATED|EMPTY_TARGET|EMPTY_SOURCE|FORCE_OUTDATED|WIP)$ ]]; then
      ...
      printf "${STY_RED}1. Check the discussions for any valid update notice.${STY_RST}\n"
      printf "   ${STY_UNDERLINE}https://github.com/create-juicey-app/ii-dotfiles-ce/discussions${STY_RST}\n"
      ...
      printf "   ${STY_UNDERLINE}https://github.com/create-juicey-app/ii-dotfiles-ce/commits/main/sdata/dist-arch${STY_RST}\n"
      printf "   ${STY_UNDERLINE}https://github.com/create-juicey-app/ii-dotfiles-ce/commits/main/sdata/dist-${TARGET_ID}${STY_RST}\n"
      printf "\n"
      ...
      printf "${STY_PURPLE}${STY_UNDERLINE}https://github.com/create-juicey-app/ii-dotfiles-ce/discussions/new?category=extra-distros${STY_RST}\n"
      printf "\n"
